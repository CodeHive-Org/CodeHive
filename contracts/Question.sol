...
contract Question {
    ...
    function submitCode(
        ...
        address _sender
    ) public onlyWebHandler returns (bool) {
    ...
    function postDiscussion(
        ...
        address _sender
    ) public onlyWebHandler {
        Chat.push(
            Message(_content, _sender, block.timestamp, 0, false, noOfChat)
        );
        noOfChat++;
    }
    ...
    function editChat(
        ...
        require(
            Chat[_index].sender == _sender,
            "require the address to match."
        );
